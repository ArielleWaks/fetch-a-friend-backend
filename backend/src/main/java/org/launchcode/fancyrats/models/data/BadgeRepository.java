...
public interface BadgeRepository extends JpaRepository<Badge, Integer> {
    ...
    Badge findBadgeByBadgeTypeAndNumberOfJobs(@Param("badgeType") BadgeType badgeType, @Param("numberOfJobs") int numberOfJobs);
...
//
//    @Query("select b from Badge b where b.badgeType = :badgeType and b.numberOfJobs = :numberOfJobs and b.petType = :petType")
//    List<Badge> findBadgesByBadgeTypeAndNumberOfJobsAndPetType(@Param("badgeType") int badgeType, @Param("numberOfJobs") int numberOfJobs, @Param("petType") int petType);
